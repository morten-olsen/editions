...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-accent text-accent-ink hover:bg-accent-hover shadow-xs active:shadow-none",
  secondary:
    "bg-surface-raised text-ink border border-border hover:bg-surface-sunken active:bg-surface-sunken",
  ghost:
    "text-ink-secondary hover:text-ink hover:bg-surface-sunken active:bg-surface-sunken",
  destructive:
    "bg-critical text-white hover:bg-critical/90 shadow-xs active:shadow-none",
};
