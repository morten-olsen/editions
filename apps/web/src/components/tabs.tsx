...
const List = ({ className = '', ...props }: React.ComponentProps<typeof BaseTabs.List>): React.ReactElement => (
  <BaseTabs.List className={`flex gap-1 border-b border-border ${className}`} {...props} />
);

const Tab = ({ className = '', ...props }: React.ComponentProps<typeof BaseTabs.Tab>): React.ReactElement => (
  <BaseTabs.Tab
