  ...
  render: () => (
    <Dialog.Root>
      ...
      <Dialog.Content>
        ...
        <Dialog.Description>
          This will permanently remove the source and all its articles. This
  ...
  render: () => (
    <Dialog.Root>
      ...
      <Dialog.Content>
        ...
        <Dialog.Description>
          Your morning edition had 5 articles across 3 focuses, totalling about
          12 minutes of reading. Enjoy the rest of your day.
        </Dialog.Description>
