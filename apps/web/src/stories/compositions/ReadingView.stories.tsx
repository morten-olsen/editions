    ...
    <div className="min-h-dvh bg-surface">
      ...
      <article className="max-w-prose mx-auto px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="font-serif text-lg leading-relaxed text-ink">
          ...
          <p className="mb-6">
            The concept isn't new — Instapaper and Readability pioneered the "reader mode" concept over a decade ago.
            But what's different now is the ambition. Modern reader apps aren't just stripping ads and reformatting
            text. They're rethinking the entire relationship between a person and their information diet.
          </p>

          <blockquote className="border-l-2 border-accent pl-6 my-8 italic text-ink-secondary">
            "The best reading experience is one where you forget you're using an app at all. The interface disappears
            and it's just you and the words."
          </blockquote>

          <p className="mb-6">
            Source budgeting is perhaps the most interesting innovation. Rather than treating all sources equally —
            where a prolific publication drowns out a thoughtful blog that posts once a week — these apps allocate
            proportional representation. The result is a feed that actually reflects the diversity of what you chose to
            follow.
          </p>
          ...
          <p className="mb-6">
            ...
            Rather than buttons, icons, and navigation bars competing for attention, the hierarchy is established
            through font choices, size, weight, and spacing. A serif typeface signals "this is content to read." A
            sans-serif signals "this is interface to interact with."
          </p>

          <p className="mb-6">
            This dual typography approach creates an almost subliminal distinction between chrome and content. Users
            report that it makes the reading experience feel more "book-like" — calm, focused, and intentionally
            bounded.
          </p>
