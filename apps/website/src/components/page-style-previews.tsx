...
const articles = [
  {
    ...
    positionInSection: 0,
    summary: 'A growing number of designers are questioning whether the infinite scroll ever served the reader at all.',
  },
  {
  ...
  },
  {
    ...
    positionInSection: 2,
    summary: 'New observations have revealed the earliest galaxies ever seen.',
  },
  {
    ...
    summary: "A conversation about designing software that respects the reader's time.",
  },
];
  ...
  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
    {articles.map((article, i) => (
      <div key={i} className="flex flex-col gap-2">
        ...
        <div className="text-center text-xs font-mono tracking-wide text-ink-faint">{LABELS[i]}</div>
      </div>
    ))}
  </div>
);
