...
| **Hybrid** | `"hybrid"` | Similarity first, NLI refinement for ambiguous scores (0.25–0.65) | Near-instant for most articles, NLI quality where it matters |
...
**Threshold:** Articles below the confidence threshold (configurable via `analysis.confidenceThreshold`, default 0.3) are not assigned to the focus.
